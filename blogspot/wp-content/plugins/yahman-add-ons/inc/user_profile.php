		...
		function yahman_addons_add_user_profile( $user ) {
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						<input class="ya_color-picker" id="icon_user_color" name="icon_user_color" type="text" value="<?php echo esc_attr( $sns_info['icon_user_color'] ); ?>" data-alpha="true" />
					</td>
				</tr>
				<tr>
					<th><label for="icon_user_hover_color"><?php esc_html_e('Specifies the color of hover.', 'yahman-add-ons'); ?></label></th>
					<td>
						<input class="ya_color-picker" id="icon_user_hover_color" name="icon_user_hover_color" type="text" value="<?php echo esc_attr( $sns_info['icon_user_hover_color'] ); ?>" data-alpha="true" />
					</td>
				</tr>
				<tr>

...
function yahman_addons_ga_gtag_noscript(){
	...
	$ga_gtag = '<!-- Google Tag Manager (noscript) -->';
	$ga_gtag .= '<noscript><iframe src="//www.googletagmanager.com/ns.html?id='. esc_attr(YA_GA_GTAG) .'&visitorType=returning" height="0"';
	$ga_gtag .= ' width="0" style="display:none;visibility:hidden"></iframe></noscript>';
	$ga_gtag .= '<!-- End Google Tag Manager (noscript) -->';
	$ga_gtag .= '<!-- Global Site Tag (gtag.js) - Google Analytics -->';

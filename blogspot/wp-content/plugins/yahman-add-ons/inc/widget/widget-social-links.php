...
class yahman_addons_social_links_widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			...
			<input class="ya_color-picker" id="<?php echo esc_attr( $this->get_field_id( 'icon_user_color' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'icon_user_color' ) ); ?>" type="text" value="<?php echo esc_attr( $settings['icon_user_color'] ); ?>" data-alpha="true" />
		</p>
		<p>
			...
			<input class="ya_color-picker" id="<?php echo esc_attr( $this->get_field_id( 'icon_user_hover_color' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'icon_user_hover_color' ) ); ?>" type="text" value="<?php echo esc_attr( $settings['icon_user_hover_color'] ); ?>" data-alpha="true" />
		</p>

	...
	public function widget( $args, $instance ) {
		...
		if ( $latest_posts->have_posts() ) :
			...
			if(function_exists('yahman_addons_amp_head')){
				...
				require_once YAHMAN_ADDONS_DIR . 'inc/amp/carousel_slider.php';
				yahman_addons_carousel_slider_amp( $settings , $latest_posts );
			}else{
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'category_not_in' ) ); ?>">
				<?php esc_html_e( ' Disappear when you type category id.', 'yahman-add-ons' ); ?><br /><?php esc_html_e( ' Multiple id must be seperated by a comma.', 'yahman-add-ons' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'post_not_in' ) ); ?>"><?php esc_html_e( ' Disappear when you type post id.', 'yahman-add-ons' ); ?><br /><?php esc_html_e( ' Multiple id must be seperated by a comma.', 'yahman-add-ons' ); ?></label>

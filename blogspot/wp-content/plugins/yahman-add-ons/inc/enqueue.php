...
function yahman_addons_highlight_load() {
	...
	wp_enqueue_style('highlight_style', YAHMAN_ADDONS_URI . 'assets/js/highlight/styles/'.$highlight_style.'.css' );
	wp_enqueue_script('highlight_script',YAHMAN_ADDONS_URI . 'assets/js/highlight/highlight.pack.js', array(), null );
	wp_add_inline_script( 'highlight_script', 'hljs.initHighlightingOnLoad();');

...
<div id="ya_ga_content" class="tab_content dn fi15">
  <h3><?php esc_html_e('Google Analytics','yahman-add-ons'); ?></h3>

  <table class="form-table">
    <tr valign="top">
      <th scope="row"><label for="ga_enable"><?php esc_html_e('Enable','yahman-add-ons'); ?></label></th>
      <td><input name="yahman_addons[ga][enable]" type="checkbox" id="ga_enable"<?php checked(true, $ga['enable']); ?> class="ya_checkbox" /></td>
    </tr>
    <tr valign="top">
      <th scope="row"><label for="ga_id"><?php esc_html_e('Property ID','yahman-add-ons'); ?></label><br />
        <label for="ga_id"><?php echo esc_html__('e.g.&nbsp;', 'yahman-add-ons').esc_html('UA-XXXXXX-Y'); ?></label>
      </th>
      <td><input name="yahman_addons[ga][id]" type="text" id="ga_id" value="<?php echo esc_attr($ga['id']); ?>" class="ya_textbox" /></td>
    </tr>
    <tr valign="top">
      <th scope="row"><label for="ga_verification"><?php esc_html_e('Google Site Verification','yahman-add-ons'); ?></label></th>
      <td><input name="yahman_addons[ga][verification]" type="text" id="ga_verification" value="<?php echo esc_attr($ga['verification']); ?>" class="ya_textbox" /></td>
    </tr>
<?php /*
    <tr valign="top">

...
?>
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		if ( is_sticky() && is_home() ) {
			...
			get_template_part( PARFUM_TEMPLATE_PARTS . 'sticky' );

		} else {

			if ( is_home() && get_theme_mod( 'parfum_full_content_homepage_and_archive', '' ) == '' ) { // Excerpts.

				get_template_part( PARFUM_TEMPLATE_PARTS . 'content-archive-excerpts' );
				...
				<div class="entry-content">
					...
					wp_link_pages( array( 'before' => '<div class="page-links">' . __( 'Pages:', 'parfum' ), 'after' => '</div>' ) );
					?>

...
function parfum_scripts_styles() {
	...
	// Excerpts columns.
	wp_enqueue_style( 'parfum-excerpt-columns-style', get_template_directory_uri() . '/css/excerpt-columns.css', '', PARFUM_VERSION );
...
function parfum_body_class( $classes ) {
	...
	if ( is_page_template( 'page-templates/template-page-builder.php' ) || is_page_template( 'page-templates/template-page-builder-no-footer.php' ) ) {

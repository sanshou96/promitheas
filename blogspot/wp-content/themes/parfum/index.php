	...
	<div id="primary" class="site-content">
		<div id="content" role="main">
			...
			if ( have_posts() ) :
				...
				while ( have_posts() ) :
					the_post();
					get_template_part( PARFUM_TEMPLATE_PARTS . 'content' );
				endwhile;
				...
				<article id="post-0" class="post no-results not-found">
					...
					// Show a different message to a logged-in user who can add posts.
						...
						<header class="entry-header">
							<h1 class="entry-title"><?php esc_html_e( 'No posts to display', 'parfum' ); ?></h1>
						</header>

						<div class="entry-content">
							<p><?php printf( __( 'Ready to publish your first post? <a href="%s">Get started here</a>.', 'parfum' ), admin_url( 'post-new.php' ) ); ?></p>
						</div><!-- .entry-content -->
